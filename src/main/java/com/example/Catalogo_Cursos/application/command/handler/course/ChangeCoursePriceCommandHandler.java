...
import com.example.Catalogo_Cursos.application.command.ChangeCoursePriceCommand;
...
public class ChangeCoursePriceCommandHandler
    implements CommandHandler<ChangeCoursePriceCommand, Void> {

  private final CourseRepository courseRepository;
  private final OutboxExecutor outboxExecutor;

  public ChangeCoursePriceCommandHandler(
  ...
  @Override
  public Class<ChangeCoursePriceCommand> commandType() {
    return ChangeCoursePriceCommand.class;
  }
