...
@Service
public class UpdateCategoryDescriptionCommandHandler
    implements CommandHandler<UpdateCategoryDescriptionCommand, Void> {

  private final CourseCategoryRepository courseCategoryRepository;
  private final OutboxExecutor outboxExecutor;

  public UpdateCategoryDescriptionCommandHandler(
  ...
  @Override
  public Class<UpdateCategoryDescriptionCommand> commandType() {
    return UpdateCategoryDescriptionCommand.class;
  }
